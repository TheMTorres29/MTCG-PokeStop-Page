...
import missingN0 from '../../assets/poke-icons/MissingnoIdle.webp'
 ...
 const pokeSprites = [
     ...
     {id: 21, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/incineroar.png'},
     {id: 22, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/mimikyu.png'},
     {id: 23, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/greedent.png'},
     ...
     {id: 27, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/hawlucha.png'},
     ...
     {id: 31, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/walking-wake.png'},
     {id: 32, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/gouging-fire.png'},
     {id: 33, src: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/raging-bolt.png'},
 ]
